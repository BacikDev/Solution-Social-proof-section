...
const reviews = [
    ...
    review: '"We needed the same printed design as the one we had ordered a week prior. Not only did they find the riginal order, but we also received it in time.Excellent!"'
    },
    {
    id: 2,
    name: 'Irene Roberts',
...
export const ReviewContainer = () => {
  ...
  return (
    <div className="flex flex-col gap-4 xl:flex-row xl:h-[256px] xl:gap-[30px]">
